...
class ClientMessagesList extends StatefulWidget {
  const ClientMessagesList({super.key});

  @override
  State<ClientMessagesList> createState() => _ClientMessagesListState();
}

class _ClientMessagesListState extends State<ClientMessagesList> {
  String? val = '';
  @override
...
class ClientsMessagesListName extends StatelessWidget {
  ClientsMessagesListName({super.key, required this.messageIndex});
  ...
  @override
  Widget build(BuildContext context) {
    BlocProvider.of<MessageCubit>(context).getClientAllDate();
    return Column(
      ...
      children: [
        ...
        BlocConsumer<MessageCubit, MessageState>(
          listener: (context, state) {
            if (state is MessageAllClientSuccess) {
              messageList = state.allClientmessages;
            }
          },
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    ...
                    child: ClientMessageItem(messageClient: messageList[index]),
                  );
                },
              ),
            );
...
class ClientMessageItem extends StatelessWidget {
  const ClientMessageItem({super.key, required this.messageClient});
...
class MessageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    BlocProvider.of<MessageCubit>(context).getClientDate(auth: parameter);
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            onPressed: () {
              if (message != null) {
                BlocProvider.of<MessageCubit>(context).postClientMessageData(
                  message: message!,
                  clientDoc: parameter,
